/*
This is a 2 state knapsack problem, that will tell me
if from a given set of items, if I can make value PMAX
profit or not
*/
#include <bits/stdc++.h>
using namespace std;
...
int main()
{
    ...
    int MXPROF;
    cout<<"MAX PROFIT YOU WANT TO MAKE = ";
	cin>>MXPROF;

    int profit = knapsack_calc(1,0);
    if(profit == MXPROF)
    {
    	cout<<"POSSIBLE TO MAKE "<<MXPROF<<" PROFIT\n";
    }
    else{
    	cout<<"IMPOSSIBLE TO MAKE "<<MXPROF<<" PROFIT\n";
    }
	return 0;
}
